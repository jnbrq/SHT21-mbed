...
PREPROC = 'arm-none-eabi-cpp' '-E' '-P' '-Wl,--gc-sections' '-Wl,--wrap,main' '-Wl,--wrap,__malloc_r' '-Wl,--wrap,__free_r' '-Wl,--wrap,__realloc_r' '-Wl,--wrap,__memalign_r' '-Wl,--wrap,__calloc_r' '-Wl,--wrap,exit' '-Wl,--wrap,atexit' '-Wl,-n' '-mcpu=cortex-m4' '-mthumb' '-mfpu=fpv4-sp-d16' '-mfloat-abi=softfp'
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1502371800.65
C_FLAGS += -DTARGET_STM
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1502371800.65
...
LD_FLAGS :=-Wl,--gc-sections -Wl,--wrap,main -Wl,--wrap,__malloc_r -Wl,--wrap,__free_r -Wl,--wrap,__realloc_r -Wl,--wrap,__memalign_r -Wl,--wrap,__calloc_r -Wl,--wrap,exit -Wl,--wrap,atexit -Wl,-n -mcpu=cortex-m4 -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=softfp 
